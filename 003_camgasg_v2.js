...
let fullSizeImage = await new Request("https://www.foto-webcam.eu/webcam/stveit/current/400.jpg").loadImage()

let croppedImage = await processImage(fullSizeImage)

var widget = new ListWidget()
widget.backgroundImage = croppedImage
// widget.addText(croppedImage.size.width.toString()); // first line for text in the widget
// widget.addText(croppedImage.size.height.toString()); // second line for text in the widget
